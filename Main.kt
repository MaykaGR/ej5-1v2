open class ArmaDeFuego(open val nombre: String, var municion: Int,
...
class Pistola(override val nombre: String ="Pistola", var municpist: Int = 15,
              val municpistARestar: Int = 1, val tipoDeMunicion: String ="Bla",
              val danio: Int = 3,  val radio: String ="Bla"):
    ArmaDeFuego(nombre,municpist,municpistARestar,tipoDeMunicion, danio, radio)
{
...
class Rifle(override val nombre: String ="Rifle", var municrif: Int = 6,
            val municrifARestar: Int = 2, val tipoDeMunicion: String ="Bla",
            val danio: Int = 5,  val radio: String = "Bla"):
    ArmaDeFuego(nombre,municrif,municrifARestar,tipoDeMunicion, danio, radio)
{
    override fun dispara(): Int{
...
class Bazooka(override val nombre: String ="Bazooka", var municbaz: Int = 8,
              val municbazARestar: Int = 3, val tipoDeMunicion: String ="Bla",
              val danio: Int = 10,  val radio: String ="Bla"):
    ArmaDeFuego(nombre,municbaz,municbazARestar,tipoDeMunicion, danio, radio)
{
    override fun dispara():Int{
